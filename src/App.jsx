    ...
    <>
      ...
      {kioskLocked ? (
        ...
        <div>
          ...
          <div className="pg">
            {adminTab === "schedule" ? <ErrorBoundary label="스케줄"><Screen render={renderCal} /></ErrorBoundary> : null}
            {adminTab === "fixed" ? <ErrorBoundary label="고정"><Screen render={renderFixed} /></ErrorBoundary> : null}
      ...
      <ErrorBoundary key={modal ? `modal-${modal.type}` : "modal-none"} label="팝업" onRetry={closeModal}><Screen render={renderModal} /></ErrorBoundary>
      {toast ? (
